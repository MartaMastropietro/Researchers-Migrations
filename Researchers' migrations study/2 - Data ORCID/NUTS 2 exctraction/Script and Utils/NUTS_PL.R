...
data_or$region[which(data_or$region=="åswiäTtokrzyskie")]<-"swietokrzyskie"
data_pc$admin.name1[which(data_pc$admin.name1=="åswiäTtokrzyskie")]<-"swietokrzyskie"
data_or$region[which(data_or$region=="å\u0081ã³dåºvoivodeship")]<-"lodz"
data_pc$admin.name1[which(data_pc$admin.name1=="å\u0081ã³dåºvoivodeship")]<-"lodz"
...
data_or$region[which(data_or$region=="maå,opolska")]<-"lesserpoland"
data_or$region[which(data_or$region=="maå,opolskie")]<-"lesserpoland"
...
data_or$region[which(data_or$region=="wojewã³dztwopodkarpackie")]<-"subcarpathia"
...
#correzioni
data_or$NUTS3[as.numeric(manuals$ID[which(manuals$City=="nowysä.cz")])] <- "PL214"
data_or$NUTS3[as.numeric(manuals$ID[which(manuals$City=="kã³rnik")])] <- "PL411"
