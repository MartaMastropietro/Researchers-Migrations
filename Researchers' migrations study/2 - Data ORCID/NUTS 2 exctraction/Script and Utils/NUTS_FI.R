library(progress)
country <- "FI"
colnames(pc2020_FI_NUTS.2021_v1.0)<-c("NUTS3", "PCode")
pc2020_FI_NUTS.2021_v1.0 <- pc2020_FI_NUTS.2021_v1.0[-1,]

data_or <- data
data_pc <- geonames.postal.codes_filtered
data_nuts <- pc2020_FI_NUTS.2021_v1.0
...
data_or$city[which(data_or$city=="jyvaskyla")]<-"centralfinlandregion"
data_or$city[which(data_or$city=="aalto")]<-"uusimaa"
data_or$city[which(data_or$city=="masala")]<-"uusimaa"
data_or$city[which(data_or$city=="abo")]<-"loimaa"
data_or$city[which(data_or$city=="ã.bo")]<-"loimaa"
data_or$city[which(data_or$city=="vasa")]<-"ostrobothniaregion"
data_or$city[which(data_or$city=="hameenlinna")]<-"kantahã¤me"
data_or$city[which(data_or$city=="helsingfors")]<-"helsinki"
data_or$city[which(data_or$city=="seinajoki")]<-"ostrobothniaregion"
...
save(data, file="C:/Users/user/Desktop/forORCID/ORCID_2021_activities_extract_uptoFI.RData")
