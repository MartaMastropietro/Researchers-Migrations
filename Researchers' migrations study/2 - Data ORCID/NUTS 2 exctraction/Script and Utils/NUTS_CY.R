library(progress)
country <- "CY"
colnames(pc2020_CY_NUTS.2021_v1.0)<-c("NUTS3", "PCode")
pc2020_CY_NUTS.2021_v1.0 <- pc2020_CY_NUTS.2021_v1.0[-1,]

data_or <- data
data_pc <- geonames.postal.codes_filtered
data_nuts <- pc2020_CY_NUTS.2021_v1.0
...
data_or$NUTS3[indices] <- "CY000"

data$NUTS3[indices] <- data_or$NUTS3[indices]
save(data, file="C:/Users/user/Desktop/forORCID/ORCID_2021_activities_extract_uptoCY.RData")
