...
data_or$city[which(data_or$city=="ð¡ð¾ñð¸ñ")]<-"sofija"
...
data_or$city[which(data_or$city=="ð'ð°ñ???ð½ð°")]<-"varna"
...
data_or$city[which(data_or$city=="pazardå¾ik")]<-"pazardzhik"
data_or$city[which(data_or$city=="plovduv")]<-"plovdiv"
data_or$city[which(data_or$city=="plovdivtown")]<-"plovdiv"
data_or$city[which(data_or$city=="ðÿð»ð¾ð²ð´ð¸ð²")]<-"plovdiv"
data_or$city[which(data_or$city=="ð³ñ???.ðÿð»ð¾ð²ð´ð¸ð²")]<-"plovdiv"
data_or$city[which(data_or$city=="saintvlas")]<-"svetivlas"
data_or$city[which(data_or$city=="ðÿð»ðµð²ðµð½")]<-"pleven"
data_or$city[which(data_or$city=="haskovo")]<-"khaskovo"
data_or$city[which(data_or$city=="ð'ð»ð°ð³ð¾ðµð²ð³ñ???ð°ð´")]<-"blagoevgrad"
data_or$region[which(data_or$region=="sofia")]<-"sofija"
data_or$region[which(data_or$region=="sofiacity")]<-"sofija"
data_or$region[which(data_or$region=="ð¡ð¾ñð¸ñ")]<-"sofija"
data_or$region[which(data_or$region=="velikotarnovo")]<-"velikoturnovo"
data_or$region[which(data_or$region=="ð'ðµð»ð¸ðºð¾ð¢ñsñ???ð½ð¾ð²ð¾")]<-"velikoturnovo"
data_or$region[which(data_or$region=="ð¡ð²ð¸ñ???ð¾ð²")]<-"velikoturnovo"
...
data_or$city[which(data_or$city=="ð¡ð¾ñ"ð¸ñ\u008f")] <- "sofija"
...
data_or$city[which(data_or$city=="ð'ð°ñ???ð½ð°")] <- "varna"
data_or$city[which(data_or$city=="ð'ñfñ???ð³ð°ñ\u0081")] <- "burgas"
data_or$city[which(data_or$city=="ð'ðµð»ð¸ðºð¾ð¢ñsñ???ð½ð¾ð²ð¾")] <- "velikoturnovo"
data_or$city[which(data_or$city=="velikotarnovo,bulgaria")] <- "velikoturnovo"
data_or$city[which(data_or$city=="ð¨ñfð¼ðµð½")] <- "shumen"
data_or$city[which(data_or$city=="ð'ð»ð°ð³ð¾ðµð²ð³ñ???ð°ð´")] <- "blagoevgrad"
